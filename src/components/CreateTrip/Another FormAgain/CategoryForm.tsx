...
async function saveForm() {
   ...
   const accommodationArray = [accommodation0, accommodation1, accommodation2, accommodation3]

   const restaurantArray = [restaurant0, restaurant1, restaurant2, restaurant3]
...
async function choicesRestaurantTable(restaurantArray:any, restaurantData:any) {
    console.log("here?")
        for(let i = 0; i < 4; i++){
    ...
    async function choicesAccomodationTable(accommodationArray:any, accommodationData:any) {
        console.log("here?")
            for(let i = 0; i < 4; i++){
    ...
    <div>
        ...
        <label>enter budget
            <input type="text" value={budget0} name="budget0" onChange={(e) => {setBudget0(e.target.value)}}></input>
            <input type="text" value={budget1} name="budget1" onChange={(e) => {setBudget1(e.target.value)}}></input>
            <input type="text" value={budget2} name="budget2" onChange={(e) => {setBudget2(e.target.value)}}></input>
            <input type="text" value={budget3} name="budget3" onChange={(e) => {setBudget3(e.target.value)}}></input>
        </label>

        <label>enter accommodation
            <input type="text" value={accommodation0} name="budget0" onChange={(e) => {setAccommodation0(e.target.value)}}></input>
            <input type="text" value={accommodation1} name="budget1" onChange={(e) => {setAccommodation1(e.target.value)}}></input>
            <input type="text" value={accommodation2} name="budget2" onChange={(e) => {setAccommodation2(e.target.value)}}></input>
            <input type="text" value={accommodation3} name="budget3" onChange={(e) => {setAccommodation3(e.target.value)}}></input>
        </label>

        <label>enter restaurant
            <input type="text" value={restaurant0} name="budget0" onChange={(e) => {setRestaurant0(e.target.value)}}></input>
            <input type="text" value={restaurant1} name="budget1" onChange={(e) => {setRestaurant1(e.target.value)}}></input>
            <input type="text" value={restaurant2} name="budget2" onChange={(e) => {setRestaurant2(e.target.value)}}></input>
            <input type="text" value={restaurant3} name="budget3" onChange={(e) => {setRestaurant3(e.target.value)}}></input>
        </label>
