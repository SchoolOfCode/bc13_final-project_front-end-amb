...
//tripDetails is a prop that is passed down from the Dashboard component
const TripDetails = ({ tripDetails, id }: any) => {
  const [dateVote, setDataVote] = useState(false);
  const [itinereryVote, setItineraryVote] = useState(false);
  const [choices, setChoices] = useState([]);

  //fetch choices which are named categories in the database
  useEffect(() => {
    const fetchData = async () => {
      const res = await fetch(`http://localhost:3001/api/trip/choices`);
  ...
  return (
    <div className="trip-details-page">
      <div className="details-layout">
        ...
        <h2>{tripDetails.choices}</h2>

        {/*<p>destination: {tripDetails.destination}</p>*/}

        {/*{tripDetails.date.length > 1 ? (*/}
        {/*  <button className="button" onClick={handleDate}>*/}
        {/*    vote on the dates!*/}
        {/*  </button>*/}
        {/*) : (*/}
        {/*  <p>*/}
        {/*    date from: {tripDetails.date[0].from} date to:{" "}*/}
        {/*    {tripDetails.date[0].to}*/}
        {/*  </p>*/}
        {/*)}*/}

        {/*{dateVote && (*/}
        {/*  <VoteWrapper title="vote on the dates">*/}
        ...
        {/*    })}*/}
        {/*    <button*/}
        {/*      className="vote-form-button button"*/}
        {/*      onClick={handleDate}*/}
        {/*    >*/}
        {/*      close*/}
        {/*    </button>*/}
        ...
        {/*<p>trip members:</p>*/}
        {/*{tripDetails.member.length > 1 ? (*/}
        {/*  tripDetails.member.map((mem: any) => {*/}
        {/*    return <p>{mem.name}</p>;*/}
        {/*  })*/}
        {/*) : (*/}
        {/*  <p>{tripDetails.member[0].name}</p>*/}
        {/*)}*/}

        {/*{tripDetails.event.length > 1 ? (*/}
        {/*  <button className="button" onClick={handleItinerary}>*/}
        {/*    vote on itinerary!*/}
        {/*  </button>*/}
        {/*) : (*/}
        ...
        {/*{itinereryVote && (*/}
        {/*  <VoteWrapper title="vote on the itinerary">*/}
        ...
        {/*                  id="clicked-event"*/}
        {/*                  onClick={() => {*/}
        {/*                    registerItineraryItem(event);*/}
        {/*                  }}*/}
        {/*                >*/}
        {/*                  {event.type} - {event.name} - {event.date_time}*/}
        {/*                </span>*/}
        {/*              </div>*/}
        {/*            );*/}
        {/*          })}*/}
        ...
        {/*      );*/}
        {/*    })}*/}
        {/*    <button className="vote-form-button" onClick={handleItinerary}>*/}
        {/*      close*/}
        {/*    </button>*/}
        {/*  </VoteWrapper>*/}
        {/*)}*/}
